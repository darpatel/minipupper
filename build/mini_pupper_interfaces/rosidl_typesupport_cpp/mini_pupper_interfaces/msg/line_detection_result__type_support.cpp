...
static const _LineDetectionResult_type_support_symbol_names_t _LineDetectionResult_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mini_pupper_interfaces, msg, LineDetectionResult)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mini_pupper_interfaces, msg, LineDetectionResult)),
  }
};
...
{
  return &::mini_pupper_interfaces::msg::rosidl_typesupport_cpp::LineDetectionResult_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mini_pupper_interfaces, msg, LineDetectionResult)() {
  return get_message_type_support_handle<mini_pupper_interfaces::msg::LineDetectionResult>();
}
