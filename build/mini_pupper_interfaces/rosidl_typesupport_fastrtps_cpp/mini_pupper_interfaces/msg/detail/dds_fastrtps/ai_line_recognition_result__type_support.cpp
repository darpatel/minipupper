...
#include "mini_pupper_interfaces/msg/detail/ai_line_recognition_result__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mini_pupper_interfaces::msg::AiLineRecognitionResult;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mini_pupper_interfaces::msg::AiLineRecognitionResult *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mini_pupper_interfaces::msg::AiLineRecognitionResult *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _AiLineRecognitionResult__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mini_pupper_interfaces::msg::AiLineRecognitionResult *>(
...
static size_t _AiLineRecognitionResult__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_AiLineRecognitionResult(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _AiLineRecognitionResult__callbacks = {
...
static rosidl_message_type_support_t _AiLineRecognitionResult__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_AiLineRecognitionResult__callbacks,
...
{
  return &mini_pupper_interfaces::msg::typesupport_fastrtps_cpp::_AiLineRecognitionResult__handle;
}
